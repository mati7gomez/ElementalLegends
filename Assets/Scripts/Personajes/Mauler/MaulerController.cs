...
public class MaulerController : BasePlayerController
{
    ...
    private void Atk1()
    {
        if (m_attack2Pressed && !playerManager.IsBusy && playerManager.IsGrounded && m_canAtk1)
        {
    ...
    private void Atk2()
    {
        if (m_attack1Pressed && !playerManager.IsBusy && playerManager.IsGrounded && m_canAtk2 && m_canCombo && m_comboNumber == 1)
        {
